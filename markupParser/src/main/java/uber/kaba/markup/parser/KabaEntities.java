...
/**
 * This was taken from apache commons lang and modified because apache bitches didn't allow to extend their classes
 */
 ...
 * </p>
 *
 * @see <a href="http://hotwired.lycos.com/webmonkey/reference/special_characters/">ISO KabaEntities</a>
 * @see <a href="http://www.w3.org/TR/REC-html32#latin1">HTML 3.2 Character KabaEntities for ISO Latin-1</a>
 * @see <a href="http://www.w3.org/TR/REC-html40/sgml/KabaEntities.html">HTML 4.0 Character entity references</a>
 ...
 * @since 2.0
 * @version $Id: KabaEntities.java 911986 2010-02-19 21:19:05Z niallp $
 */
public class KabaEntities {
    ...
    // http://www.w3.org/TR/REC-html40/sgml/KabaEntities.html
    // package scoped for testing
    ...
    /**
     * <p>
     * The set of KabaEntities supported by standard XML.
     * </p>
     */
    public static final KabaEntities XML;

    /**
     * <p>
     * The set of KabaEntities supported by HTML 3.2.
     * </p>
     */
    public static final KabaEntities HTML32;

    /**
     * <p>
     * The set of KabaEntities supported by HTML 4.0.
     * </p>
     */
    public static final KabaEntities HTML40;

    static {
        KabaEntities xml = new KabaEntities();
        xml.addKabaEntities(BASIC_ARRAY);
        xml.addKabaEntities(APOS_ARRAY);
        XML = xml;
    }

    static {
        KabaEntities html32 = new KabaEntities();
        html32.addKabaEntities(BASIC_ARRAY);
        html32.addKabaEntities(ISO8859_1_ARRAY);
        HTML32 = html32;
    }

    static {
        KabaEntities html40 = new KabaEntities();
        fillWithHtml40KabaEntities(html40);
        HTML40 = html40;
    }

    /**
     * <p>
     * Fills the specified KabaEntities instance with HTML 40 KabaEntities.
     * </p>
     *
     * @param KabaEntities
     *            the instance to be filled.
     */
    static void fillWithHtml40KabaEntities(KabaEntities KabaEntities) {
        KabaEntities.addKabaEntities(BASIC_ARRAY);
        KabaEntities.addKabaEntities(ISO8859_1_ARRAY);
        KabaEntities.addKabaEntities(HTML40_ARRAY);
    }
    ...
    static abstract class MapIntMap implements KabaEntities.EntityMap {
     ...
     */
    public KabaEntities(){
        map = new KabaEntities.LookupEntityMap();
    }
     ...
     */
    KabaEntities(EntityMap emap){
        map = emap;
    }

    /**
     * <p>
     * Adds KabaEntities to this entity.
     * </p>
     *
     * @param entityArray
     *            array of KabaEntities to be added
     */
    public void addKabaEntities(String[][] entityArray) {
    ...
    public void escape(Writer writer, String str) throws IOException {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (c == '&') {
                ...
                writer.write(str.substring(i, semiColonIdx+1));
    ...
    /**
     * <p>
     * Unescapes the KabaEntities in a <code>String</code>.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Unescapes the escaped KabaEntities in the <code>String</code> passed and writes the result to the
