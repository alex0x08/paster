...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
		...
		ignorePath: '../../resources',
  		src: ['src/main/webapp/WEB-INF/pages/template/template-common-head.jsp'],
		...
		fileTypes: {
                    jsp: {
                        ...
                        replace: {
                            js: '<script type="text/javascript" src="<c:url value=\'/main/resources/${appId}{{filePath}}\'/>"></script>',
                            css: '<link type="text/css" href="<c:url value=\'/main/resources/${appId}{{filePath}}\'/>" rel="stylesheet"/>'
                        }
                    }
                }
            },
	    pasteView: {
		src: ['src/main/webapp/index2.html'],
		"bowerJson": {
      			"dependencies": {
             			}
    			}
