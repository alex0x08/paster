...
<li class="nav-item dropdown">
    <a href="#" id="userProfileSwitch" role="button" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="userProfileSwitch">
        ...
        <li class="nav-item dropdown" >
            ...
            <form:form cssClass="form-inline" style="padding-left:1em;" role="form" action="${logoutUrl}" method="POST">
