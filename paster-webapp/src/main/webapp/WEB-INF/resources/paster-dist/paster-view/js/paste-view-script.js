...
;(function()
{
	...
	BrushAS3.prototype	= new SyntaxHighlighter.Highlighter();
	BrushAS3.aliases	= ['actionscript3', 'as3'];

	SyntaxHighlighter.brushes.AS3 = BrushAS3;


        function BrushAppleScript()
	{
	...
	BrushAppleScript.prototype = new SyntaxHighlighter.Highlighter();
	BrushAppleScript.aliases = ['applescript'];

	SyntaxHighlighter.brushes.AppleScript = BrushAppleScript;
	...
	BrushCS.prototype	= new SyntaxHighlighter.Highlighter();
	BrushCS.aliases	= ['coldfusion','cf'];
	
	SyntaxHighlighter.brushes.ColdFusion = BrushCS;
	...
	BrushDelphi.prototype	= new SyntaxHighlighter.Highlighter();
	BrushDelphi.aliases	= ['delphi', 'pascal', 'pas'];

	SyntaxHighlighter.brushes.Delphi = BrushDelphi;
	...
	BrushGroovy.prototype	= new SyntaxHighlighter.Highlighter();
	BrushGroovy.aliases	= ['groovy'];

	SyntaxHighlighter.brushes.Groovy = BrushGroovy;
	...
	BrushJavaFX.prototype	= new SyntaxHighlighter.Highlighter();
	BrushJavaFX.aliases	= ['jfx', 'javafx'];

	SyntaxHighlighter.brushes.JavaFX = BrushJavaFX;
