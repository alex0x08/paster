...
/**
 * Tiles [[org.apache.tiles.preparer.factory.PreparerFactory]] implementation
...
class SpringBeanPreparerFactory extends AbstractSpringPreparerFactory {
  ...
  override protected def getPreparer(name: String,
                                     context: WebApplicationContext): ViewPreparer =
