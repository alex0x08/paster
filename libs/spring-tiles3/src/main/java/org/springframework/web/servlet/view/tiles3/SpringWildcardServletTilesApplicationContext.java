...
public class SpringWildcardServletTilesApplicationContext extends ServletApplicationContext {
    ...
    public Collection<ApplicationResource> getResources(String path) {
        ...
        try {
            ...
            // do not log this error: tiles tries to load tiles-defs/*.xml from META-INF by default.
        ...
        final Collection<ApplicationResource> resourceList = new ArrayList<>(resources.length);
