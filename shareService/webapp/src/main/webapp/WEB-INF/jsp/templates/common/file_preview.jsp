                ...
                <div>
                    <c:if test="${not empty model.xml.fields}">
                        <c:forEach var="field" items="${model.xml.fields}">
                            ...
                            <a href="<c:url value='/main/file/list/search?query=${field.value.name}:${field.value.value}'/>" 
                               target="${not empty param.integrationMode ? "_blank" : target}">
                                <h2 class="label label-info"><c:out value="${field.value.name}"/> =
                                    <c:out value="${field.value.value}"/> 
                                </h2>
                            </a>    
                        </c:forEach>
